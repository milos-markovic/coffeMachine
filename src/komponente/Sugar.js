    ...
    return (
      <div className="card pb-3 mb-3 border border-dark sugar-bg">
        ...
        <div className="display card-body">
          <button onClick = {this.props.reduceSugar} ><FontAwesomeIcon icon={faMinusCircle} className="icon"/></button>
          <div className="display_sugar">
            <div style={sugarValue} >
            </div>
          </div>
          <button onClick={this.props.increseSugar} ><FontAwesomeIcon icon={faPlusCircle} className="icon" /></button>
        </div>
      </div>
